...
Adapted from gsa.reshape.concordance.table.R <https://github.com/broadinstitute/gsalib/blob/master/R/gsa.reshape.concordance.table.R>
...
EvalGenotypes in rows and the CompGenotypes in column.
